...
function katt(){
if (inputEmail1.value.match(regx) && pass.value.match(/[a-z]*[0-9]*[A-Z]*[!\@\#\$\%\^\&\*\(\)\_\-\+\=\?\>\<\.\,]/g) && email1.value === email2.value && jelszo1.value === jelszo2.value && email1.value != "" && email2.value != "" && jelszo1.value != "" && jelszo2.value != ""){
